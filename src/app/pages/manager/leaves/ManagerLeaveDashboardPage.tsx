...
import { LeaveStatCard } from "../../../components/leaves/manager/LeaveStatCard";
import { ManagerLeaveStatusBadge } from "../../../components/leaves/manager/ManagerLeaveStatusBadge";
import { formatLeaveShortDate } from "../../../components/leaves/manager/leaveDateUtils";
...
export function ManagerLeaveDashboardPage() {
  const navigate = useNavigate();
  const { balances, applications, holidays, year, teamApplications, leaveTypes } = useManagerLeaveData();
