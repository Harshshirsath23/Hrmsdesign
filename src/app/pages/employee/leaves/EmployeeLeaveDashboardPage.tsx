      ...
      <header className="rounded-3xl border border-border bg-card p-5 shadow-sm">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild variant="outline" size="sm" className="h-11 rounded-3xl border-border px-4 text-sm font-semibold">
              <Link to="/employee/leaves/applications">View applications</Link>
            </Button>
            <Button asChild size="sm" className="h-11 rounded-3xl bg-foreground px-4 text-sm font-semibold text-primary-foreground">
