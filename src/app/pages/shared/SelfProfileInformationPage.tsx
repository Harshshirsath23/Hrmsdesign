    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FieldRow label="Passport Category"><Input value={value.passportCategory ?? employee.passportCategory ?? ""} onChange={(v) => set("passportCategory", v)} /></FieldRow>
          <FieldRow label="Passport Status">
            <Select value={value.passportStatus ?? employee.passportStatus ?? ""} onChange={(v) => set("passportStatus", v)} options={["Valid", "Expired", "Renewal In Progress"]} />
          </FieldRow>
