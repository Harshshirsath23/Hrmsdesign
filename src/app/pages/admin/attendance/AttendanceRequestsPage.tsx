...
export function AttendanceRequestsPage() {
  ...
  const { data: requests = [], isLoading, isError, error, refetch } = useAttendanceRequests(requestQueryParams);
  ...
  const isRequestMutating = approveMutation.isLoading || rejectMutation.isLoading;
