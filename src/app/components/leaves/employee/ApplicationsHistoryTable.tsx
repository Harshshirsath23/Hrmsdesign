...
export function ApplicationsHistoryTable({
  ...
  const filterSelect =
    "flat-input h-11 min-w-[8rem] flex-1 rounded-2xl px-3 text-sm font-medium sm:min-w-0 sm:flex-none sm:max-w-[12rem]";
  ...
  return (
    <div className="space-y-4">
      <div className="flat-card bg-card p-4 sm:p-5 rounded-3xl">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="relative min-w-0 flex-1 max-w-md">
            ...
            <input
              ...
              className="flat-input h-11 w-full rounded-2xl pl-11 pr-4 text-sm"
            />
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <Button
              ...
              variant="outline"
              size="sm"
              className="h-11 gap-2 rounded-2xl border-border text-sm font-semibold"
