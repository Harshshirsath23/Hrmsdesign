          ...
          <div className="space-y-1.5">
            ...
            <Select value={filters.shift} onValueChange={(v) => updateFilter("shift", v)}>
              ...
              <SelectContent>
                ...
                {MOCK_SHIFTS.map(s => <SelectItem key={s} value={s} className="text-xs">{s.split('(')[0]}</SelectItem>)}
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={filters.department} onValueChange={(v) => updateFilter("department", v)}>
              ...
              <SelectContent>
                ...
                {MOCK_DEPARTMENTS.map(d => <SelectItem key={d} value={d} className="text-xs">{d}</SelectItem>)}
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={filters.designation} onValueChange={(v) => updateFilter("designation", v)}>
              ...
              <SelectContent>
                ...
                {MOCK_DESIGNATIONS.map(d => <SelectItem key={d} value={d} className="text-xs">{d}</SelectItem>)}
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={filters.team} onValueChange={(v) => updateFilter("team", v)}>
              ...
              <SelectContent>
                ...
                {MOCK_TEAMS.map(t => <SelectItem key={t} value={t} className="text-xs">{t}</SelectItem>)}
              </SelectContent>
            </Select>
          </div>
        </div>
