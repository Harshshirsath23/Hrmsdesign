        ...
        <div className="flex-1 flex flex-wrap items-center gap-2">
          ...
          <Select value={filters.department} onValueChange={(v) => updateFilter("department", v)}>
            ...
            <SelectContent>
              ...
              {MOCK_DEPARTMENTS.map(d => <SelectItem key={d} value={d} className="text-[11px]">{d}</SelectItem>)}
            </SelectContent>
          </Select>
          ...
          <Select value={filters.designation} onValueChange={(v) => updateFilter("designation", v)}>
            ...
            <SelectContent>
              ...
              {MOCK_DESIGNATIONS.map(d => <SelectItem key={d} value={d} className="text-[11px]">{d}</SelectItem>)}
            </SelectContent>
          </Select>
          ...
          <Select value={filters.team} onValueChange={(v) => updateFilter("team", v)}>
            ...
            <SelectContent>
              ...
              {MOCK_TEAMS.map(t => <SelectItem key={t} value={t} className="text-[11px]">{t}</SelectItem>)}
            </SelectContent>
          </Select>
