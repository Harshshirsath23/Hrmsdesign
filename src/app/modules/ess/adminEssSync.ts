...
export function mergeAdminEmployeeIntoEssProfile(admin: Employee, profile: EmployeeProfile): EmployeeProfile {
  ...
  return {
    ...
    personalDetails: {
      ...
      height: admin.height || (profile.personalDetails as any).height || "",
      weight: admin.weight || (profile.personalDetails as any).weight || "",
    ...
    emergencyAndMedical: {
      ...
      hasDisease: admin.medicalInfo?.hasDisease ?? profile.emergencyAndMedical?.hasDisease ?? false,
      diseaseDescription: admin.medicalInfo?.diseaseDescription || profile.emergencyAndMedical?.diseaseDescription || "",
      hasSurgery: admin.medicalInfo?.hasSurgery ?? profile.emergencyAndMedical?.hasSurgery ?? false,
      surgeryDescription: admin.medicalInfo?.surgeryDescription || profile.emergencyAndMedical?.surgeryDescription || "",
    },
...
export function mergeEssEmployeeOwnedIntoAdmin(admin: Employee, profile: EmployeeProfile): Employee {
  ...
  return {
    ...
    height: profile.personalDetails.height || admin.height,
    weight: profile.personalDetails.weight || admin.weight,
    ...
    medicalInfo: {
      ...
      hasDisease: em?.hasDisease,
      diseaseDescription: em?.diseaseDescription,
      hasSurgery: em?.hasSurgery,
      surgeryDescription: em?.surgeryDescription,
    },
