      ...
      >
        <motion.div
          ...
          className={cn(
            ...
            "bg-[#1d1d1f]/40 backdrop-blur-3xl shadow-[0_20px_60px_-10px_rgba(0,0,0,0.5)] ring-1 ring-white/10",
            "dark:bg-black/40 dark:ring-white/5",
          ...
          {visibleModules.map((module, index) => (
            <React.Fragment key={module.key}>
              ...
              {(module.key === 'ai' || module.key === 'settings') && (
                <div className="mx-1.5 mb-2.5 h-8 w-[1px] bg-white/10 self-end" />
              )}
              <DockIcon
                module={{
                  ...module,
